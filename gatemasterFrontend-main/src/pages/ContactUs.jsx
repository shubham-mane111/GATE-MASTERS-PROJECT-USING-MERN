  ...
  return (
    <div className='bg-white'>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-stone-200 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <h1 className="text-lg font-semibold text-black">Chat on us</h1>
                    </div>
                    <p className='font-medium'>Our friendly team is here to help.</p>
                    <p className='font-semibold'>prashantjagtap2909@gmail.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <h1 className="text-lg font-semibold text-black">Visit us</h1>
                    </div>
                    <p className='font-medium'>Come and say hello at our </p>
                ...
                <p className='font-medium'>Mon - Sat From 8am to 5pm</p>
